...
?>      
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">                                
                        ...
                        <div class="btn-group pull-right">
                                ...
                                <li><a href="cetak.php?tingkat_kelas=<?= $_POST['tingkat_kelas']; ?>&id_kelas=<?= $_POST['id_kelas']; ?>&angkatan_siswa=<?= $_POST['angkatan_siswa']; ?>&id_pembayaran=<?= $_POST['id_pembayaran']; ?>&aktif_siswa=<?= $_POST['aktif_siswa']; ?>&status_lunas=<?= $_POST['status_lunas']; ?>" target="_blank" class="btn btn-info"><i class="fa fa-print"></i> Cetak</a>
                                </li>
    ...
    <tr >
        ...
        <td align="center"></td>><?= $keterangan_pembayaran; ?></td>
    </tr>
