                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group hidden">
                            ...
                            <div class="col-md-3 col-xs-5">
                                <?php
                                    $kurang = $config->getData("SELECT SUM(nominal_transaksi) as nominal FROM tbl_transaksi WHERE id_siswa='". $r['id_siswa'] ."' AND id_kelas = '". $kelas_siswa ."' AND id_pembayaran='". $p['id_pembayaran'] ."'");
                    ...
                    <div class="panel-body table-responsive">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php 
                                    $i=1;
                                    $histori = $config->getData("SELECT * FROM tbl_transaksi t, tbl_siswa s, tbl_pegawai p WHERE t.id_kelas = '". $kelas_siswa ."' AND t.id_siswa = s.id_siswa AND t.id_pegawai = p.id_pegawai AND t.id_siswa='". $r['id_siswa'] ."' AND t.id_pembayaran ='". $jenis_pembayaran ."'");
                    ...
                    <div class="panel-body table-responsive">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php 
                                    $i=1;
                                    $histori = $config->getData("SELECT *, t.id_kelas as tid FROM tbl_transaksi t, tbl_siswa s, tbl_pegawai p, tbl_pembayaran pm WHERE pm.id_pembayaran = t.id_pembayaran AND t.id_kelas <> '". $kelas_siswa ."' AND t.id_siswa = s.id_siswa AND t.id_pegawai = p.id_pegawai AND t.id_siswa='". $r['id_siswa'] ."' AND t.id_pembayaran ='". $jenis_pembayaran ."' GROUP BY t.id_kelas");
                                ...
                                <?php
                                    $transaksi = $config->getData("SELECT * FROM tbl_transaksi WHERE id_transaksi='". $h['id_transaksi'] ."'");

                                    foreach ($transaksi as $t) {
                                        $id_kelas_transaksi = $t['id_kelas'];
                                    }

                                    $kurang = $config->getData("SELECT SUM(nominal_transaksi) as nominal FROM tbl_transaksi WHERE id_siswa='". $r['id_siswa'] ."' AND id_kelas = '". $id_kelas_transaksi ."' AND id_pembayaran='". $h['id_pembayaran'] ."'");
