    ...
    <?php 
        ...
        //menangkap nilai form
            ...
            else
            {
                ...
                $sql = "SELECT * FROM tbl_transaksi_isedentil t, tbl_siswa s, tbl_pegawai p, tbl_pembayaran_isedentil pn, tbl_kelas k WHERE t.waktu_transaksi BETWEEN '$tanggal_a' AND '$tanggal_b' AND t.id_siswa = s.id_siswa AND t.id_pegawai = p.id_pegawai AND t.id_pembayaran_isedentil = pn.id_pembayaran_isedentil AND t.id_kelas = k.id_kelas ORDER BY t.id_transaksi_isedentil DESC";
        ...
        ?>        
            <head>
                ...
                <style>
                #watermark { position: absolute; bottom: 0px; right: 35px; width: 90%; top: 40px; opacity: .1; }
                @page {margin: 7mm; }
        ...
        <body onload="window.print()">
                ...
                <div class="container">
                    <div class="tes">
                        <!-- <div id="watermark">
                            <img src="../../assets/man2.jpg" height="40%" width="100%">
                        </div>
                         -->
                        ...
                        <div class="" align="center" >
                            <h5 style="margin:0px;" align="CENTER">Jalan Soekarno Hatta Kelurahan Balai Nan Duo Kecamatan Payakumbuh barat <br>
                             ...
                             <h5 style="margin: 0px;" align="center"> &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; Website : man2kotapayakumbuh.sch.id Email : mandua_pyk@yahoo.com <br></h5>
                              <h5 style="margin: 0px;" align="center"> &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp;
                                Kode Pos : 26224 Telepon (0752) 92152<br>
                            </h5>
                        </div>                       
                        <hr class="new4">
        ...
        <br>
            ...
            <table width="92%" style="margin-top:-25px;">
                 <tr>
                    <td align="center">
                        Mengetahui, <br>
                        Kepala Madrasah
