...
if(!empty($_SESSION['kodeakses'])) {
    ...
    $result = $config->getData("SELECT * FROM tbl_pembayaran_isedentil WHERE id_pembayaran_isedentil='$id3'");

    if($result==false) {
        echo ("<script LANGUAGE='JavaScript'>
                window.location.href='". $base_url ."page/pembayaran-isedentil';
                </script>");
    }
    foreach ($result as $r):    
?> 
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
						...
						?>
                        <input type="hidden" class="form-control" name="id_pembayaran_isedentil" required="" value="<?= $en3; ?>" />
