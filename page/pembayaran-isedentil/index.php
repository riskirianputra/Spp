<?php
    ...
    $page       = "Pembayaran Isedentil";
    $menu       = "Pembayaran Isedentil";
    $submenu    = "";
    $config = new Config();
    include "hak-akses.php";
    
    $query = "SELECT * FROM tbl_pembayaran_isedentil ORDER BY id_pembayaran_isedentil DESC";
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
										<?php 
											$id1 =base64_encode($r['id_pembayaran_isedentil']);
