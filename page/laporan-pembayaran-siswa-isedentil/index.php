<?php
    ...
    $page       = "Laporan Pembayaran Siswa Isedentil";
                ...
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12"> 
                                <select class="form-control select" name="id_pembayaran_isedentil">
                                    <option value="all">Semua</option>
                                    <?php
                                        $query_pembayaran = $config->getData("SELECT * FROM tbl_pembayaran_isedentil");

                                        foreach ($query_pembayaran as $qp) {
                                    ?>
                                            <option value="<?= $qp['id_pembayaran_isedentil']; ?>"><?= $qp['nama_pembayaran']; ?></option>
                                    <?php
                                        }
                                    ?>
                                </select>     
