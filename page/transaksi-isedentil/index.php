<?php
    ...
    $result = $config->getIsedentil($query);
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12"> 
                                <input type="text" class="form-control" name="nis" placeholder="Masukan Nomor Induk Siswa"  onkeypress="return isNumberKey(event)" />    
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12"> 
                                ...
                                <?php
                                    $query_pembayaran = $config->getData("SELECT * FROM tbl_pembayaran_isedentil WHERE aktif_pembayaran='1' ORDER BY id_pembayaran_isedentil DESC");
                                    foreach ($query_pembayaran as $qp) {
                            
                                    echo "<option value='". $qp['id_pembayaran_isedentil'] ."'>". $qp['nama_pembayaran'] ."</option>";
                                    }
                                ?>
                        ...
                        <table class="table datatable ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
									<?php 
										$enidtransaksi1=base64_encode($r['id_transaksi_isedentil']);
										...
										$enidpembayaran1=base64_encode($r['id_pembayaran_isedentil']);
