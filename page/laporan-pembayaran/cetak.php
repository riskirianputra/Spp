...
<html>
    ...
    <body onload="window.print()">
        ...
        <div class="tes">
            <div id="watermark">
                <img src="'. $base_url . 'assets/man2.jpg" height="70%" width="100%">
            </div>
            ...
            <div class="bagiansetengah">
                <img src="'. $base_url . 'assets/man2.jpg" height="50" width="50" align="right">
            </div>
            ...
            <table width="100%" border="1" cellpadding="5">
                ...
                <tr>
                    ...
                    <td>'. $config->format_rupiah($r['nominal_pembayaran']) .'</td>
                </tr>
                <tr>
